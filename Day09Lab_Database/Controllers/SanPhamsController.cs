...
namespace Day09Lab_Database.Controllers
{
    public class SanPhamsController : Controller
    {
        ...
        {
            var day09QuanLyBanHangContext = _context.SanPhams.Include(s => s.MaLoaiNavigation);
            return View(await day09QuanLyBanHangContext.ToListAsync());
        }

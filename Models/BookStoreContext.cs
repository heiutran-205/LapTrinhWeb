...
public partial class BookStoreContext : DbContext
{
    ...
    public virtual DbSet<Publisher1> Publishers1 { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=HIEU;Database=BookStore;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A6CAFC974A");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C20773E010D6");
        ...
        modelBuilder.Entity<Book1>(entity =>
        {
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.Book1s).HasForeignKey(d => d.CategoryId);

            entity.HasOne(d => d.Publisher).WithMany(p => p.Book1s).HasForeignKey(d => d.PublisherId);
        });
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0BFB31D08E");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCFFF894477");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C77E26374");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FAB2FFAEA19");
        ...
        modelBuilder.Entity<Publisher1>(entity =>
        {
